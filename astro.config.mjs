...
export default defineConfig({
  ...
  redirects: {
    ...
    '/kundenverwaltung': '/funktionen/kundenverwaltung/',
    '/buchhaltung': '/funktionen/buchhaltung/',
    // BLOG
    '/rechnung-auf-englisch-schreiben': '/blog/rechnung-auf-englisch-schreiben/',
    '/rechnung-schreiben-welche-pflichtangaben': '/blog/rechnung-schreiben-welche-pflichtangaben/',
    '/die-umsatzsteuer-id-alle-facts': '/blog/die-umsatzsteuer-id-alle-facts/',
    '/rechnung-eu-ausland-diese-infos-brauchst-du': '/blog/rechnung-eu-ausland-diese-infos-brauchst-du/',
    '/kleinunternehmer-rechnung': '/blog/kleinunternehmer-rechnung/',
    '/gobd-leitfaden': '/blog/gobd-leitfaden/',
    '/buchhaltung-regeln': '/blog/buchhaltung-regeln/',
    '/vorteile-online-steuerberater': '/blog/vorteile-online-steuerberater/',
    '/der-jahresabschluss': '/blog/der-jahresabschluss/',
    '/euer-2021-selbst-erstellen': '/blog/euer-2021-selbst-erstellen/',
    '/einnahmenueberschussrechnung': '/blog/einnahmenueberschussrechnung/',
    '/kleinunternehmerregelung': '/blog/kleinunternehmerregelung/',
  },
  integrations: [
    tailwind(),
    compress({
